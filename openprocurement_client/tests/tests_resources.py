...
class UserTestCase(BaseTestClass):
    ...
    def test_patch_agreement(self):
        ...
        tender_id = TEST_TENDER_KEYS_AGREEMENT.tender_id
        agreement_id = TEST_TENDER_KEYS_AGREEMENT.agreement_id
        patched_agreement = self.client.patch_agreement(tender_id, agreement, agreement_id)
    ...
    def test_patch_agreement_contract(self):
        ...
        patched_contract = self.client.patch_agreement_contract(
                           TEST_TENDER_KEYS_AGREEMENT.tender_id,
                           agreement_id,
                           contract,
                           contract.data.id
                           )
